...
Bioc: repo, rOpenSci: repo, CRAN: .tar.gz file

Might change: Read policies

## How?

### Automatic checks

First automated checks BiocCheck; R CMD check --as-cran, travis/Github Actions/...
...
Bioconductor: In detail comment of style, code classes, structure...\
rOpenSci: guideline for reviewer
s
...
Remove: \
[CRAN](https://cran.r-project.org/web/packages/policies.html): Archived when an ERROR in a new x.y.0 version.
\
