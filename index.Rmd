...
df <- data.frame(Guides = guides,
                 ...
                 Reviewers = reviewers)
rownames(df) <- repos
knitr::kable(t(df), otuput = "html", align = "c")
```
...
Some answers on blog posts for [Bioconductor](https://llrs.dev/2020/07/bioconductor-submissions-reviews/), [rOpenSci](https://llrs.dev/2020/09/ropensci-submissions/), [CRAN](https://llrs.dev/2021/01/cran-review/). 
