...
((bioc_author_reviewer_comments / bioc_auth_other_comments) & theme(legend.position = "left") & plot_layout(guides = "collect", ncol = 1))  |
(ros_author_editor_comments + ros_auth_other_comments + plot_layout(guides = "collect", ncol = 1))
```
...
success_dates <- ap0 %>% 
  ...
  scale_x_datetime(date_labels = "%y/%m", breaks = fdates, 
                   expand = expansion()) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
