...
- Other: Grant, work, prestige ...

--

.pull-left[
**Package reviews systems**
...
- Publication quality and a package’s contribution has to be non-trivial.
- Promote high-quality, well documented, and interoperable software
...
setup <- c("None", "ssh key, subscribe to mailing list", "None")
...
cran %>% 
  ...
  scale_color_manual(values = man_colors) +
  labs(x = element_blank(), y = element_blank(),
       title = "Holidays zoom", col = "Folder") +
