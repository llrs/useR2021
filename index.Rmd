...
meta() %>%
  ...
  meta_social(
    ...
    image_alt = paste(
      ...
      "Horizontal axis the date, vertical axis the submissions on Bioconductor each point is an event on a submission. It shows a continous increase on packages submitted.", 
...
Short, brief, to the point reviews
