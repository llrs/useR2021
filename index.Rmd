...
author: "[Lluís Revilla](https://llrs.dev) @[Lluis_Revilla](https://twitter.com/Lluis_Revilla) "
...
bioc_author_reviewer_comments <- bioc_by_issue %>% 
  ...
  labs(size = "Issues", x = "Authors", y = "Reviwers", title = "Comments")
...
bioc_auth_other_comments <- bioc_by_issue %>% 
  ...
  labs(size = "Issues", x = "Authors", y = "Other", title = "Comments")
...
ros_author_editor_comments <- ros_by_issue %>% 
  ...
  labs(size = "Issues", x = "Authors", y = "Editors", title = "Comments")
...
ros_auth_other_comments <- ros_by_issue %>% 
  ...
  labs(size = "Issues", x = "Authors", y = "Reviewers & other", title = "Comments")

(bioc_author_reviewer_comments + bioc_auth_other_comments) /
  (ros_author_editor_comments + ros_auth_other_comments)
```
